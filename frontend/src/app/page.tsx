  ...
  const features = [
    {
      ...
      description:
        "Get reliable, verified data through our decentralized oracle network with built-in dispute resolution mechanisms.",
    },
    {
      icon: <Zap className="w-6 h-6 text-blue-600" />,
      title: "Lightning Fast",
      description:
        "Real-time data delivery with sub-second response times across multiple blockchain networks.",
    },
    {
      icon: <Globe className="w-6 h-6 text-blue-600" />,
      title: "Cross-Chain Ready",
      description:
        "Seamlessly operate across Ethereum, Avalanche, Base, and other major blockchain networks.",
    },
    {
      icon: <Users className="w-6 h-6 text-blue-600" />,
      title: "Community Driven",
      description:
        "Powered by a global network of data providers, challengers, and reviewers ensuring data integrity.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why Choose Equolibrium?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built for developers, traders, and DeFi protocols that need
              reliable, verified real-world data on blockchain networks.
            </p>
          </div>
      ...
      <section id="how-it-works" className="bg-gray-50 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              How Equolibrium Works
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A simple, transparent process that ensures data accuracy through
              economic incentives
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg">
                Receive verified, accurate data on-chain. Rewards are
                distributed to honest participants automatically.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Equolibrium. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
